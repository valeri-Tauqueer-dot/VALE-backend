...
class VALECore:
    ...
    def __init__(self):
        ...
        # Talking Brain
        #
        # This is a communication layer, not a replacement for the
        # specialized VALE brains. It receives their results after the
        # BrainNetwork has finished processing the request.
        # --------------------------------------------------------------
    ...
    def process(
        ...
        # --------------------------------------------------------------
        # Talking Brain response layer
        #
        # The existing brains do the actual specialized work. Talking
        # Brain only receives their returned information and converts
        # it into a user-facing English response.
        #
        # IMPORTANT: failure here never breaks the existing VALE
        # pipeline. We immediately fall back to the original response
        # extraction below.
        # --------------------------------------------------------------
        ...
        try:
            ...
            brain_response = self.talking_brain.respond(
                user_message=original_message,
        ...
        # --------------------------------------------------------------
        # Original VALE response extraction remains the fallback.
        # --------------------------------------------------------------

        response_source = "talking_brain"
